...
import { registerSchema, RegisterFormValues } from '@/utils/authSchemas';
    ...
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-background via-background to-accent/40 px-4 py-10">
      ...
      >
        <div className="mb-8 flex flex-col items-center gap-2 text-center">
          ...
          <h1 className="font-display text-2xl font-bold tracking-tight">BizPilot AI</h1>
          <p className="text-sm text-muted-foreground">Set up your business in under a minute</p>
        </div>

        <Card className="border-border/60 shadow-xl shadow-black/5">
          <CardHeader>
            <CardTitle>Create your account</CardTitle>
            <CardDescription>Start managing your business with AI + onchain trust</CardDescription>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4" noValidate>
              <div className="space-y-2">
                <Label htmlFor="businessName">Business name</Label>
                <Input id="businessName" placeholder="Ada's Fashion Store" {...register('businessName')} />
                {errors.businessName && (
